...
start_svc portal 8030 \
  "cd '$ROOT/5-ui/portal-api' && PORTAL_STATIC_DIR='$ROOT/5-ui/portal-web/dist' POSTGRES_HOST=127.0.0.1 POSTGRES_PORT=5433 REDIS_URL=redis://127.0.0.1:6380 KAFKA_BOOTSTRAP_SERVERS=localhost:29092 SCHEMA_REGISTRY_URL=http://127.0.0.1:8081 PLATFORM_API_URL=http://127.0.0.1:8020 AI_ORCHESTRATOR_URL=http://127.0.0.1:8000 AGGREGATOR_URL=http://127.0.0.1:8010 TRADING_BOT_URL=http://127.0.0.1:8011 AUDITING_URL=http://127.0.0.1:8012 DASHBOARD_URL=http://127.0.0.1:8013 MARKETPLACE_URL=http://127.0.0.1:8014 ML_SERVICE_URL=http://127.0.0.1:8090 KAFKA_CONNECT_URL=http://127.0.0.1:8083 ELASTICSEARCH_URL=http://127.0.0.1:9200 FLINK_URL=http://127.0.0.1:8082 exec python3 -m uvicorn main:app --host 0.0.0.0 --port 8030"
